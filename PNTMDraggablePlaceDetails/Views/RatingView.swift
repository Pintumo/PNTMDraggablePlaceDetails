...
class RatingView: UIView {
    ...
    init(with rating: CGFloat) {
        ...
        for _ in 0..<fullStars { stars.append(UIImageView(image: #imageLiteral(resourceName: "star_full"))) }
        for _ in 0..<halfStars { stars.append(UIImageView(image: #imageLiteral(resourceName: "star_half"))) }
        for _ in 0..<emptyStars { stars.append(UIImageView(image: #imageLiteral(resourceName: "star_empty"))) }
