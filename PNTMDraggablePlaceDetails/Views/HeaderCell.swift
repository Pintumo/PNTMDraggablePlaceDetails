...
class HeaderCell: UITableViewCell {
    ...
    init() {
        ...
        let routeButtonImage = #imageLiteral(resourceName: "icon_travelModel").withRenderingMode(.alwaysTemplate)
        ...
        let shareButtonImage = #imageLiteral(resourceName: "icon_share").withRenderingMode(.alwaysTemplate)
